...
function  [C, W, sigma2, iter, T, G] =cpd_GRBF(X, Y, beta, lambda, max_it, tol, viz, outliers, fgt, corresp,sigma2);
...
tol_sigma2 = 1e-8;
while (iter<max_it) && (ntol > tol) && (sigma2 > tol_sigma2) %(sigma2 > 1e-8)
